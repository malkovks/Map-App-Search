...
class OnboardingViewController: UIViewController {
    ...
    private let cellData = [
        OnboardingData(title: "Приветствие", info: "Меня зовут Константин и я рад представить вашему вниманию мое приложение Поиск на Карте. Обязательно изучите информацию ниже, чтобы в полной мере насладиться использованием приложения!", image: UIImage(named: "appleMap")!),
