//
//  DirectinResultTableViewCell.swift
//  Map Search App
//
//  Created by Константин Малков on 14.02.2023.
//
...
class DirectionResultTableViewCell: UITableViewCell {
    
    static let identifier = "DirectionResultTableViewCell"
